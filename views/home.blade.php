	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-sm-4">
				<div class="service-container">
					<div class="service-photos">
						<a href="/betonvloer/terrassen-en-opritten"><img src="{{ Theme::url('img/beton.jpg')}}"></a>
					</div>
			...
			<div class="col-md-4 col-sm-4">
				<div class="service-container">
					<div class="service-photos">
						<a href="/betonvloer/woningen"><img src="{{ Theme::url('img/beton.jpg')}}"></a>
					</div>
					<h3>Woningen</h3>
			...
			<div class="col-md-4 col-sm-4">
				<div class="service-container">
					<div class="service-photos">
						<a href="/betonvloer/tuinhuizen-en-bijgebouwen"><img src="{{ Theme::url('img/beton.jpg')}}"></a>
					</div>
